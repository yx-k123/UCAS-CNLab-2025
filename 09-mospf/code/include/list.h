...
static inline void list_insert(struct list_head *new_list,
...
static inline void list_add_head(struct list_head *new_list, struct list_head *head)
{
	list_insert(new_list, head, head->next);
}

// add a list node at the tail of the list 
static inline void list_add_tail(struct list_head *new_list, struct list_head *head)
{
	list_insert(new_list, head->prev, head);
}
