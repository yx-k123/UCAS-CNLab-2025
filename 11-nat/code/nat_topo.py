...
if __name__ == '__main__':
    ...
    net.start()
    # # snat
    n1.cmd('./nat exp1.conf > ./log/n1_snat.log 2>&1 &')
    h3.cmd('python3 ./http_server.py > ./log/h3_snat.log 2>&1 &')
    h1.cmd('wget http://159.226.39.123:8000 > ./log/h1_snat.log 2>&1 &')
    h2.cmd('wget http://159.226.39.123:8000 > ./log/h2_snat.log 2>&1 &')

    # dnat
    # n1.cmd('./nat exp2.conf > ./log/n1_dnat.log 2>&1 &')
    # h1.cmd('python3 ./http_server.py > ./log/h1_dnat.log 2>&1 &')
    # h2.cmd('python3 ./http_server.py > ./log/h2_dnat.log 2>&1 &')
    # h3.cmd('wget http://159.226.39.43:8000 > ./log/h3_dnat_8000.log 2>&1 &')
    # h3.cmd('wget http://159.226.39.43:8001 > ./log/h3_dnat_8001.log 2>&1 &')
    CLI(net)
    net.stop()
