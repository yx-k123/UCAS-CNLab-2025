...
if __name__ == '__main__':
    ...
    # h1 ping h2/h3
    # h1.cmd('ping 10.0.0.2 -c 2 > ./log/h1_ping_h2.log')

    # h1 client h2/h3 server
    # h2.cmd('iperf -s &')
    # h3.cmd('iperf -s &')
    # h1.cmd('iperf -c 10.0.0.2 -t 15 > ./log/h1_to_h2.log &')
    # h1.cmd('iperf -c 10.0.0.3 -t 15 > ./log/h1_to_h3.log &')

    # h1 server h2/h3 client
    # kill previous iperf server instances

    # h1.cmd('iperf -s &')
    # h2.cmd('iperf -c 10.0.0.1 -t 15 > ./log/h2_to_h1.log &')
    # h3.cmd('iperf -c 10.0.0.1 -t 15 > ./log/h3_to_h1.log &')
