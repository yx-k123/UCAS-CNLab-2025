...
if __name__ == '__main__':
    ...
    # h2.cmd('iperf -s &')
    # h3.cmd('iperf -s &')
    # h1.cmd('iperf -c 10.0.0.2 -t 15 > ./log/h1-2.log &')
    # h1.cmd('iperf -c 10.0.0.3 -t 15 > ./log/h1-3.log &')

    h1.cmd('iperf -s &')
    h2.cmd('iperf -c 10.0.0.1 -t 15 > ./log/h2-1.log &')
    h3.cmd('iperf -c 10.0.0.1 -t 15 > ./log/h3-1.log &')
